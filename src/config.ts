...
export const siteConfig: SiteConfig = {
	...
	navbarTitle: {
		...
		// 网站Logo图片路径
		logo: "assets/home/Gemini_Generated_Image_n1n0vfn1n0vfn1n0.png",
	},
	...
	bilibili: {
		vmid: "391416966", // ← 已更新为你的 Bilibili UID
...
export const musicPlayerConfig: MusicPlayerConfig = {
	...
	meting_api:
		"https://api.injahow.cn/meting/?server=:server&type=:type&id=:id&auth=:auth&r=:r", // 公共 Meting API 地址
	id: "2872398452", // ← 已更新为你的网易云歌单ID
...
export const pioConfig: import("./types/config").PioConfig = {
	...
	dialog: {
		welcome: "欢迎来到Cup-fish的小窝！", // ← 已更新为中文欢迎词
		touch: ["你在干嘛呢？", "别戳我啦～", "坏家伙！", "不许欺负我！"], // ← 已更新为中文触摸提示
		home: "点这里回到首页哦！", // ← 已更新为中文
		skin: ["想看看我的新衣服吗？", "新衣服好看吗～"], // ← 已更新为中文
		close: "QWQ 下次再见～", // 关闭提示
		link: "https://github.com/Cup-fish",
	},
};
